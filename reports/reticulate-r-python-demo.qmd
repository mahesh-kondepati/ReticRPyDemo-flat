...
It is similar to Rmarkdown, a polished extension to it. An big feature of Quarto is that it also supports languages apart from R, like say Python.
...
use_condaenv("retic_demo", conda = "C:/Users/mahes/anaconda3/Scripts/conda.exe", required = TRUE)
```
