...
│                         reticulate-demo and configuration for tools like black
│
...
│
└── reticulate-demo   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes reticulate-demo a Python module
    │
